...
#line 1 "c:\\edk2\\Build\\NT32X64\\DEBUG_VS2017\\X64\\MdeModulePkg\\Universal\\DriverSampleDxe\\DriverSampleDxe\\DEBUG\\DriverSampleStrDefs.h"
...
#line 247 "c:\\edk2\\Build\\NT32X64\\DEBUG_VS2017\\X64\\MdeModulePkg\\Universal\\DriverSampleDxe\\DriverSampleDxe\\DEBUG\\DriverSampleStrDefs.h"

#line 249 "c:\\edk2\\Build\\NT32X64\\DEBUG_VS2017\\X64\\MdeModulePkg\\Universal\\DriverSampleDxe\\DriverSampleDxe\\DEBUG\\DriverSampleStrDefs.h"
#line 1 "c:\\edk2\\MdeModulePkg\\Universal\\DriverSampleDxe\\Vfr.vfr"
...
#line 29 "c:\\edk2\\mdemodulepkg\\universal\\driversampledxe\\NVDataStruc.h"
...
#line 30 "c:\\edk2\\mdemodulepkg\\universal\\driversampledxe\\NVDataStruc.h"
...
#line 38 "c:\\edk2\\MdeModulePkg\\Include\\Guid/DriverSampleHii.h"
#line 31 "c:\\edk2\\mdemodulepkg\\universal\\driversampledxe\\NVDataStruc.h"
...
#line 26 "c:\\edk2\\MdeModulePkg\\Include\\Guid/ZeroGuid.h"
#line 32 "c:\\edk2\\mdemodulepkg\\universal\\driversampledxe\\NVDataStruc.h"
...
#line 136 "c:\\edk2\\mdemodulepkg\\universal\\driversampledxe\\NVDataStruc.h"
#line 18 "c:\\edk2\\MdeModulePkg\\Universal\\DriverSampleDxe\\Vfr.vfr"
...
formset
  ...
  namevaluevarstore MyNameValueVar,                
    name = STRING_TOKEN(0x008E), 
    name = STRING_TOKEN(0x008F), 
  ...
  form formid = 1,                                
    ...
    suppressif ideqval MyIfrNVData.SuppressGrayOutSomething == 0x0;
      ...
      orderedlist
                ...
                option text = STRING_TOKEN(0x008B), value = 2, flags = 0;
                option text = STRING_TOKEN(0x008A), value = 1, flags = 0;
                option text = STRING_TOKEN(0x008C), value = 3, flags = 0;
              suppressif ideqval MyIfrNVData.BootOrderLarge == 0;
                option text = STRING_TOKEN(0x008D), value = 4, flags = 0;
              endif;
      endlist;
    ...
    oneof varid  = MyIfrNVData.TestLateCheck,
      ...
      warningif prompt = STRING_TOKEN(0x00A8), timeout = 5,
  ...
  form formid = 3, title = STRING_TOKEN(0x0017);  
    ...
    grayoutif  match2 (stringref(STRING_TOKEN(0x00AC)), stringref(STRING_TOKEN(0x00AB)), { 0x63E60A51, 0x497D, 0xD427, {0xC4, 0xA5, 0xB8, 0xAB, 0xDC, 0x3A, 0xAE, 0xB6 }});
      numeric 
  ...
  formmap formid = 4,            
    ...
    oneof varid = MyIfrNVData.SerialPortNo,    
      ...
      option text = STRING_TOKEN(0x0094), value = 0x0, flags = DEFAULT;
      option text = STRING_TOKEN(0x0095), value = 0x1, flags = 0;
      option text = STRING_TOKEN(0x0096), value = 0x2, flags = 0;
      option text = STRING_TOKEN(0x0097), value = 0x3, flags = 0;
      option text = STRING_TOKEN(0x0098), value = 0x4, flags = 0;
    endoneof;
    ...
    grayoutif TRUE;
      suppressif ideqval MyIfrNVData.SerialPortStatus == 0;
        oneof varid = MyIfrNVData.SerialPortIo,    
          ...
          option text = STRING_TOKEN(0x009C), value = 0x3F8, flags = DEFAULT;
          option text = STRING_TOKEN(0x009D), value = 0x2F8, flags = 0;
          option text = STRING_TOKEN(0x009E), value = 0x3E8, flags = 0;
          option text = STRING_TOKEN(0x009F), value = 0x2E8, flags = 0;
        endoneof;
      endif;
    endif;
    ...
    grayoutif TRUE;
      suppressif ideqval MyIfrNVData.SerialPortStatus == 0;
        oneof varid = MyIfrNVData.SerialPortIrq,    
          ...
          option text = STRING_TOKEN(0x00A0), value = 0x4, flags = DEFAULT;
          option text = STRING_TOKEN(0x00A1), value = 0x3, flags = 0;
        endoneof;
      endif;
    endif;
